    ...
    const jsonLd = {
        ...
        "itemListElement": fusions.map((fusion, index) => ({
            ...
            "item": {
                ...
                "creditText": "AI Generated Fan Art via FusionGenerator.fun",
                "copyrightNotice": "Pokémon properties © Nintendo/Game Freak. Fusions generated by AI.",
                "acquireLicensePage": "https://fusiongenerator.fun/pokemon#faq"
            }
        }))
    };
