        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Pick from library or upload images</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Set fusion strength for perfect blending</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Create HD fusion image in seconds</p>
            </div>
          </div>
