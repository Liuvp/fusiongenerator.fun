    ...
    const faqSchema = {
        ...
        "mainEntity": [
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Visitors get 3 free fusions without login. Register to save your fusions to history and start with 2 starter credits. The studio is fully responsive and works perfectly on mobile browsers like Chrome and Safari."
                }
            }
        ]
    };
