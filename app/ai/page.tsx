    ...
    step: [
        {
            ...
            text: "Click the upload areas in the fusion studio to select two clear images from your device.",
            image: "https://fusiongenerator.fun/images/character-fusion-mashup-ai-generator.webp",
        },
        {
            "@type": "HowToStep",
            ...
            text: "Select your preferred fusion style (Balanced, Artistic, Realistic) for different visual outcomes.",
            image: "https://fusiongenerator.fun/images/character-fusion-mashup-ai-generator.webp",
        },
        {
            "@type": "HowToStep",
            ...
            text: "Click the 'Generate Fusion' button. Once processed, download your high-quality, watermark-free result.",
            image: "https://fusiongenerator.fun/images/character-fusion-mashup-ai-generator.webp",
        },
    ],
};
        ...
        <>
            <Script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify([faqSchema, breadcrumbJsonLd, howToJsonLd, webPageJsonLd]),
                }}
            />

            <div id="main-content" className="min-h-screen bg-background">
                <div className="container px-4 py-8 sm:px-6 sm:py-12">
                    <div className="mx-auto max-w-5xl space-y-10 sm:space-y-12 md:space-y-16">
                        <section className="space-y-4 text-center sm:space-y-6" role="region" aria-labelledby="hero-title">
                            <div className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1.5 text-xs font-medium text-primary sm:text-sm">
                                <Sparkles className="mr-1.5 h-3.5 w-3.5 sm:mr-2 sm:h-4 sm:w-4" aria-hidden="true" focusable="false" />
                                AI-Powered Fusion Studio
                            </div>
                            <h1 id="hero-title" className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
                                AI Fusion Generator
                                <span className="mt-2 block text-2xl font-semibold text-muted-foreground sm:text-3xl md:text-4xl">
                                    Merge Any Two Images with AI
                                </span>
                            </h1>
                            <div className="group relative mx-auto my-6 aspect-[16/9] w-full max-w-4xl overflow-hidden rounded-xl bg-muted shadow-2xl">
                                <Image
                            ...
                            <p className="mx-auto max-w-xl px-2 text-base leading-relaxed text-muted-foreground sm:max-w-2xl sm:text-lg">
                            ...
                            <div className="flex flex-col justify-center gap-3 px-4 sm:flex-row sm:px-0">
                                <Button asChild className="h-12 rounded-xl px-6 text-base sm:h-11 sm:text-sm">
                                    <Link href="#fusion-studio" aria-label="Jump to the upload studio and start with two images">
                                        Jump to Upload Studio
                                    </Link>
                                </Button>
                                <Button asChild variant="outline" className="h-12 rounded-xl px-6 text-base sm:h-11 sm:text-sm">
                                    <Link href="/gallery" aria-label="View our gallery of community AI fusions">
                                        View Gallery
                                    </Link>
                                </Button>
                            </div>
                        ...
                        <section className="space-y-6" role="region" aria-labelledby="about-title">
                            <h2 id="about-title" className="border-l-4 border-primary pl-4 text-2xl font-bold">
                                About Our AI Fusion Generator
                            </h2>
                        ...
                        <section className="space-y-8" role="region" aria-labelledby="features-title">
                            <h3 id="features-title" className="text-center text-xl font-bold sm:text-left sm:text-2xl">
                                Why Choose Our AI Fusion
                            </h3>
                            <div className="scrollbar-hide -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 sm:mx-0 sm:grid sm:grid-cols-3 sm:px-0 sm:pb-0">
                                {[
                                    {
                                        icon: Wand2,
                                        title: "AI-Powered Blending",
                                        desc: "Deep learning algorithms analyze and merge images intelligently.",
                                        color: "text-primary",
                                        bg: "bg-primary/10",
                                    },
                                    {
                                        ...
                                        desc: "Generate professional-quality fusions in seconds, not hours.",
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "Choose from balanced, artistic, or realistic fusion styles.",
                                    ...
                                    <Card
                                        key={index}
                                        className="w-[280px] flex-shrink-0 snap-start border-2 shadow-sm transition-colors hover:border-primary/20 sm:w-auto"
                                    >
                                        <CardHeader className="pb-2">
                                            <div className={`mb-3 flex h-11 w-11 items-center justify-center rounded-xl shadow-sm sm:h-12 sm:w-12 ${feature.bg}`}>
                        ...
                        <section className="space-y-6" role="region" aria-labelledby="examples-title">
                            <h3 id="examples-title" className="text-xl font-bold sm:text-2xl">
                                Example AI Fusions
                            </h3>
                            <p className="text-sm leading-relaxed text-gray-500 sm:text-base">
                                Explore stunning examples created with our engine. From character combinations to creative artwork blends, see what is possible with just two clicks.
                            </p>
                            <div
                                className="scrollbar-hide -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 focus:outline-none focus:ring-2 focus:ring-primary/50 sm:mx-0 sm:grid sm:grid-cols-2 sm:px-0 sm:pb-0"
                                role="list"
                        ...
                        <section className="space-y-8" role="region" aria-labelledby="faq-title">
                            <header className="space-y-2 border-l-4 border-secondary pl-4">
                                <h3 id="faq-title" className="text-xl font-bold text-gray-900 sm:text-2xl">
                                ...
                                <CardContent className="p-0">
                                    <dl className="divide-y divide-gray-100">
                                        {faqSchema.mainEntity.map((item, index) => (
                                            <div key={index} className="group space-y-2 p-5 sm:p-6">
                                                <dt className="flex items-start gap-2 text-base font-bold text-gray-900 transition-colors group-hover:text-primary">
                                                ...
                                                <dd className="flex gap-2 pl-6">
                                                    <span className="flex-shrink-0 font-black text-orange-600" aria-hidden="true">
                                                        A:
                                                    </span>
                        ...
                        <section className="space-y-6 px-4 py-8 text-center sm:px-0" role="region" aria-label="Call to action">
                            <div className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1.5 text-xs font-medium text-primary sm:text-sm">
                                <Sparkles className="mr-1.5 h-3.5 w-3.5 sm:mr-2 sm:h-4 sm:w-4" aria-hidden="true" focusable="false" />
                            ...
                            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
                                <Button asChild className="h-12 w-full rounded-xl px-8 text-base shadow-lg shadow-primary/20 sm:h-11 sm:w-auto sm:text-sm">
                                    <Link href="#fusion-studio" aria-label="Go to the fusion studio to start creating">
                                        Jump to Upload Studio
                                    </Link>
                                </Button>
                                <Button asChild variant="outline" className="h-12 w-full rounded-xl px-8 text-base hover:bg-muted sm:h-11 sm:w-auto sm:text-sm">
