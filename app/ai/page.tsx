                        ...
                        <div id="fusion-studio" className="space-y-6 scroll-mt-20">
                            ...
                            <Card className="border-2 shadow-sm">
                                <CardContent className="p-6 space-y-8">
                                    ...
                                    <div className="grid gap-6 md:grid-cols-2">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="text-xs text-muted-foreground">
                                                Pro Tip: Use clear, front-facing images for best results
                                            </div>
                                        </div>
                                    ...
                                    {/* Fusion Strength Slider */}
                                    <div className="space-y-2">
                                        <div className="text-sm font-medium">Fusion Strength: 60%</div>
                                        <input
                                            type="range"
                                            min="0"
                                            max="100"
                                            defaultValue="60"
                                            className="w-full h-2 rounded bg-muted"
                                        />
                                        <div className="text-xs text-muted-foreground">
                                            Adjust how much each image contributes to the final fusion
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
