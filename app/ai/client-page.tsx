    ...
    if (isLimit && isGuestLimit) {
        return {
            ...
            authGate: {
                ...
                description: "Guest access includes 2 free generations. Sign in or create a free account before your next one.",
            },
        };
    }
...
export default function AIFusionStudioPage() {
    ...
    const quotaStatusCopy = useMemo(() => {
        ...
        if (quota.type === "anonymous") {
            return {
                title: "Keep generating with a free account",
                description: "Guest access includes 2 free generations. Sign in before uploading and generating again.",
            ...
            {showGuestStartBanner && (
                <div className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900">
                    ...
                    <p className="mt-1 text-xs sm:text-sm text-blue-800">
                        You can try 2 guest fusions right now. We only ask you to sign in after that if you want to keep going, save your work, or move between AI, Dragon Ball, and Pokemon tools.
                    </p>
