...
export default function AboutPage() {
    const aboutSchema = {
        ...
        "description": "An AI-powered platform for creating character fusions of Dragon Ball and Pokemon characters.",
        "founder": {
            "@type": "Person",
            "name": "Liu Longquan"
        },
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2 mt-8 pt-6 border-t border-border">
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-2">
                                                ...
                                                >
                                                    Visit Contact Page <ArrowRight className="ml-1 h-3 w-3 transition-transform group-hover:translate-x-1" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
