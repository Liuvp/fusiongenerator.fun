        ...
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Card className="border-2">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  We clearly explain what data we collect and how we use it to provide you with the best fusion generation experience.
                </p>
              </CardContent>
            </Card>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {/* Back to Home button removed: duplicate of breadcrumbs */}
            </div>
          </motion.div>
        </div>
      </div>
