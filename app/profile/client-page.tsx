  ...
  const loadUserData = async () => {
    try {
      ...
      if (currentUser) {
        ...
        if (customerData) {
          setSubscription(customerData.subscriptions?.[0] || null);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container px-4 md:px-6 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="mb-6 bg-gradient-to-r from-orange-500/10 via-pink-500/10 to-purple-500/10 border-primary/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-2xl">{credits}</p>
                  </div>
                </div>
              </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="saved" className="gap-2">
                ...
                Saved Fusions ({savedNames.length})
              </TabsTrigger>
            </TabsList>
                ...
                <Card>
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Start creating your first character fusion!
                    </p>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-3 flex-1 cursor-pointer" onClick={() => handleViewBatch(batch.id)}>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-muted-foreground">
                                ...
                                <div className="flex items-center gap-2">
                                  <Search className="h-4 w-4" />
                                  Created {batch.totalNamesGenerated} fusions
                                </div>
                                <div className="flex items-center gap-2">
            ...
            <TabsContent value="saved" className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold">Saved Fusions</h2>
                <Badge variant="secondary">
                  {savedNames.length} fusions total
                </Badge>
              </div>
              ...
              {isLoadingSaved ? (
                ...
                <Card>
                  <CardContent className="p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium mb-2">No Saved Fusions</h3>
                    <p className="text-muted-foreground mb-4">
                      Click "Save" when creating fusions to save your favorites
                    </p>
                    <Button onClick={() => router.push('/')}>
                      Create Fusion
                    </Button>
          ...
          <DialogHeader>
            ...
            <DialogDescription className="space-y-2">
              ...
              <span className="text-sm text-muted-foreground">
                This will permanently delete all {batchToDelete?.totalNamesGenerated} generated fusions
