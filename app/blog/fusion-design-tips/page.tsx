...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: "Design Tips: How to Create Perfect Character Fusions",
        description: "Master the art of character fusion. Learn design principles, color theory, and tips.",
        url: "https://fusiongenerator.fun/blog/fusion-design-tips",
        type: "article",
        images: [
            {
                url: "/images/blog/fusion-design-tips-cover.png",
                width: 1200,
                height: 630,
                alt: "Character Fusion Design Tips Cover"
            }
        ]
    },
    twitter: {
        ...
        title: "Design Tips: How to Create Perfect Character Fusions",
        description: "Master the art of character fusion. Learn design principles and tips.",
        images: ["/images/blog/fusion-design-tips-cover.png"],
    }
};
...
export default function FusionDesignTipsPage() {
    const articleSchema = {
        ...
        "@type": "BlogPosting",
        headline: "Design Tips: How to Create Perfect Character Fusions",
        description: "Master the art of character fusion. Learn design principles, color theory, and tips to make your Dragon Ball and Pokemon fusions look professional.",
        image: "https://fusiongenerator.fun/images/blog/fusion-design-tips-cover.png",
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": "https://fusiongenerator.fun/blog/fusion-design-tips"
        }
    };
            ...
            <article className="container max-w-4xl py-12 px-4 md:px-6">
                ...
                <div className="my-8 rounded-2xl overflow-hidden border shadow-lg">
                    <div className="relative w-full aspect-video bg-muted">
                        <Image
                            src="/images/blog/fusion-design-tips-cover.png"
                            alt="Character Fusion Design Studio"
                            fill
                ...
                <div className="prose prose-lg max-w-none text-gray-700">
                    ...
                    <div className="mt-8 flex gap-4">
                        <Button asChild size="lg" className="bg-purple-600 hover:bg-purple-700 text-white">
                            <Link href="/ai?ref=blog_design">Create AI Fusion</Link>
                        </Button>
                    </div>
                </div>
            </article>
